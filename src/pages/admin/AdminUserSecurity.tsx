    ...
    return (
        <div className="flex flex-col w-full h-full pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 mt-8">
                <div>
                    <h1 className="text-4xl  font-normal text-foreground tracking-tight">Security & Auth</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-4xl">
                <div className="flex flex-col">
                    <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border/10">
                        ...
                        <h4 className="text-xl  font-normal text-foreground">Alertas de Login</h4>
                    </div>
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border/10">
                        ...
                        <h4 className="text-xl  font-normal text-foreground">Taxa de MFA</h4>
                    </div>
