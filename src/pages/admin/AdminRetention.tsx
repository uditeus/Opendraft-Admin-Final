    ...
    return (
        <div className="flex flex-col w-full h-full pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 mt-8">
                <div>
                    <h1 className="text-4xl  font-normal text-foreground tracking-tight">Retention Analysis</h1>
            ...
            <div className="w-full mb-16">
                <h3 className="text-xl  text-foreground mb-4">Retenção de Usuários Médio</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12 max-w-4xl">
                <div className="flex flex-col">
                    ...
                    <p className="text-4xl  font-normal text-red-500/80">4.2%</p>
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-4xl  font-normal text-emerald-600/80">33.9%</p>
