    ...
    return (
        <div className="flex flex-col w-full h-full pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 mt-8">
                <div>
                    <h1 className="text-4xl font-serif font-normal text-foreground tracking-tight">AI Limits</h1>
            ...
            <div className="w-full">
                <h3 className="text-xl font-serif text-foreground mb-4">Configurações de Rate Limit</h3>
                ...
                <div className="space-y-0 max-w-2xl border-t border-border/10">
                    <div className="flex justify-between items-center py-6 border-b border-border/10 group">
                        ...
                        <span className="text-xl font-serif tabular-nums text-foreground">5 req/min</span>
                    </div>
                    <div className="flex justify-between items-center py-6 border-b border-border/10 group">
                        <span className="text-sm font-semibold text-foreground">Tier Pro</span>
                        <span className="text-xl font-serif tabular-nums text-foreground">50 req/min</span>
                    </div>
                    <div className="flex justify-between items-center py-6 border-b border-border/10 group">
                        <span className="text-sm font-semibold text-foreground">Tier Max</span>
                        <span className="text-xl font-serif tabular-nums text-foreground">120 req/min</span>
                    </div>
                </div>
            </div>
        </div>
