    ...
    return (
        <div className="flex flex-col w-full h-full pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 mt-8">
                <div>
                    <h1 className="text-4xl font-serif font-normal text-foreground tracking-tight">Queues & Workers</h1>
            ...
            <div className="w-full">
                <div className="flex items-center justify-between mb-8 pb-4 border-b border-border/10">
                    <h3 className="text-xl font-serif text-foreground">Status das Filas</h3>
                ...
                <div className="space-y-0 max-w-2xl">
                    <div className="flex justify-between items-center py-6 border-b border-border/10">
                        ...
                        <span className="text-xl font-serif tabular-nums text-muted-foreground">0 jobs</span>
                    </div>
                    <div className="flex justify-between items-center py-6 border-b border-border/10">
                        <span className="text-sm font-semibold text-foreground">AI Generations</span>
                        <div className="flex items-center gap-4">
                            <div className="h-2 w-2 rounded-full bg-amber-500 animate-pulse" />
                            <span className="text-xl font-serif tabular-nums text-foreground">12 jobs pending</span>
                        </div>
                    </div>
                    <div className="flex justify-between items-center py-6 border-b border-border/10">
