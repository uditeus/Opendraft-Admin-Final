    ...
    return (
        <div className="flex flex-col w-full h-full pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 mt-8">
                <div>
                    <h1 className="text-4xl font-serif font-normal text-foreground tracking-tight">Knowledge Base</h1>
            ...
            <div className="w-full flex-1 flex flex-col items-center justify-center py-32 text-center">
                ...
                <h3 className="text-2xl font-serif font-normal text-foreground mb-4">Knowledge Base (RAG)</h3>
