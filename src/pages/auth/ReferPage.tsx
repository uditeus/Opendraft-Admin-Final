...
import { Loader2, ChevronRight, Eye, EyeOff, ArrowLeft, Gift } from "lucide-react";
...
export default function ReferPage() {
    ...
    return (
        <AuthLayout
            title={step === 1 ? "Você foi convidado!" : "Defina sua senha"}
            subtitle={step === 1 ? (
                "Cadastre-se para reivindicar seu bônus de indicação."
            ) : (
        ...
        >
            <div className="flex flex-col gap-4">
                {/* Referral Badge */}
                <div className="flex items-center justify-center gap-2.5 h-12 rounded-[22px] bg-white border border-border shadow-sm mb-2 w-full">
                    <Gift className="w-4 h-4 text-black" />
                    <span className="text-[13px] font-medium text-black">
                        Cadastre-se e ganhe 10 créditos grátis
                    </span>
                </div>
