                ...
                <div>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex items-center justify-between py-3">
                          <div className="flex flex-col gap-0.5">
                            <span className="text-sm font-medium text-foreground">{tt("Exibir recentes", "Show recents")}</span>
                            <span className="text-xs text-muted-foreground">{tt("Mostrar lista de conversas recentes na barra lateral", "Show list of recent conversations in the sidebar")}</span>
                          </div>
                          <Switch
                            checked={store.showRecents}
                            onCheckedChange={store.setShowRecents}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  {active === "conta" && (
                    <div className="space-y-0 text-[13px]">
                      ...
                      {/* Logout */}
                      <div className="flex items-center justify-between py-4 border-b border-border/10 transition-all px-2 -mx-2 rounded-lg cursor-pointer hover:bg-red-50 dark:hover:bg-red-950/20 group" onClick={() => signOut()}>
                        <div className="flex flex-col gap-0.5">
                          <span className="font-semibold text-foreground/90 group-hover:text-red-600 dark:group-hover:text-red-400">{tt("Desconectar dispositivos", "Disconnect devices")}</span>
                        ...
                        <span className="text-foreground/60 font-semibold transition-colors group-hover:text-red-600 dark:group-hover:text-red-400">{tt("Sair de tudo", "Logout all")}</span>
                      </div>
