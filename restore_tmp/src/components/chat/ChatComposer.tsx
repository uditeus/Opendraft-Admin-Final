...
export function ChatComposer({
  ...
  React.useEffect(() => {
    ...
    const hero = uiVariant === "hero" && mode !== "workspace";

    // Hero composer has a fixed-height bar (120px). Keep textarea constrained.
    if (hero) {
      el.style.height = "100%";
      return;
    }
      ...
      <div className="w-full chat-container">
        {questionnaire ? (
          ...
          <div className="relative">
            ...
            >
              <div className="relative h-full px-3 py-3 flex flex-col">
                {renderAtMenu(COMMAND_ANCHOR_LEFT_WITH_PLUS_PX)}

                <div
                  className="px-1 flex-1 flex flex-col min-h-0 cursor-text"
                ...
                >
                  <textarea
                    ...
                    className={cn(
                      "chat-scroll block w-full resize-none bg-transparent px-3 mt-4 pb-2 text-[15px] leading-6 text-foreground placeholder:text-muted-foreground",
